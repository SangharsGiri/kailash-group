                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade active in" id="home">
                            ...
                            <table class="form-table">
                                ...
                                <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label> Title <span class="asterisk">*</span>
                                        </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <input type="text" name="title" data-validation-allowing="float"
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        ...
                                        if(isset($detail['featured_img']) && file_exists($path.$detail['featured_img']))
                                        {
                                            ...
                                            <div class="remove_option">
                                                ...
                                                <img src="<?php echo $path. $detail['featured_img'];?>"  style="max-width: 940px; max-height: 360px;">
                                ...
                                <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label> URL <span class="asterisk">*</span>
                                        </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <input type="text" name="partner_url" data-validation-allowing="float"
                                               size="50" data-validation="required"
                                               value="<?php echo (isset($detail['partner_url']) && $detail['partner_url'] != "") ? $detail['partner_url'] : ""; ?>"
                                               autocomplete="off" class="regular-text required valid"
                                               kl_virtual_keyboard_secure_input="on"></td>
                                </tr>
