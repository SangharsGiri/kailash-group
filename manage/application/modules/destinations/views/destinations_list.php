    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <i class="fa fa-plus-square-o"></i><a href="<?php echo site_url('destinations/form');?>"> Add New Destination</a>
            </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        foreach($records as $row)
                        {
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center">
                                    <div class="btn-group">
                                        <a href="<?php echo site_url('destinations/form/'. $row['content_id']);?>" class="btn btn-success" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
                                        <a href="<?php echo site_url('destinations/comment/'. $row['content_id']);?>" class="btn btn-primary" title="Comments"><i class="fa fa-commenting-o"></i></a>
                                        <a class="btn btn-info" data-target="#myModal_news<?php echo $row['content_id'];?>" data-toggle="modal"  title="Send"><i class="fa fa-newspaper-o"></i></a>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <input type="hidden" class="hidden_link_news" value="<?php echo site_url('destinations/send/'. $row['content_id']); ?>">
                                    ...
                                    <div id="myModal_delete<?php echo $row['content_id'];?>" class="modal fade" role="dialog">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <input type="hidden" class="hidden_link_delete" value="<?php echo site_url('destinations/delete/'. $row['content_id']); ?>">
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
