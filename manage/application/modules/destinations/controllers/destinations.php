...
class Destinations extends MX_Controller{
    public function __Construct()
    {
        ...
        $this->load->model('destinations_model','content');
    ...
    public function index()
    {
        ...
        $data['title']= "Destinations List";
        $this->load->view('header', $data);
        $this->load->view('destinations_list');
    ...
    public function form($id=0)
    {
        ...
        if($this->input->post())
        {
           ...
           // $insert['parent_id'] = $this->input->post('parent_id');
            ...
            if($insert['content_type'] == "Destination")
            {
                $insert['parent_id'] = $this->input->post('parent_id');
...
//                    exit;
        ...
        $this->load->view('header', $data);
        $this->load->view('destinations_form');
        $this->load->view('footer');
    }
    ...
    public function check_name_exist($str, $content_id)
    {
        ...
        {
            $this->form_validation->set_message('check_name_exist', 'Destination page title already exist.');
            return FALSE;
        }
    ...
    public function comment($id)
    {
        ...
        if($detail['content_type']=="Destination")
        {
            redirect('destinations');
        }
