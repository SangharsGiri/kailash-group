  <?php
    $path  = base_url("uploads/tour/");
     foreach ($tourss as $tour) { 
    ?>
 <div class="section-sliderimg">
        <img src="<?php echo $path.$tour['featured_img']; ?>" alt="">
        <div class="overlay">
            <div class="caption">
                <h1><?php echo $tour['tour_title']; ?></h1>
                <p><?php
                   $string = $tour['tour_body'];;
        ...
        <div class="container">
            <div class="row car-detail">
                ...
                <div class="car-blog col-md-12">
                        <div class="row">
                            <div class="col-md-8 ">
                                <h1><?php echo $tour['tour_title']; ?><span></span></h1>
                                ...
                                <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title=""
                                   ...
                                   data-target="#image-gallery">
                                    <img class="img-thumbnail"
                                         src="<?php echo $path.$tour['featured_img']; ?>"
