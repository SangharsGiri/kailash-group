  <?php
    $path  = base_url("uploads/activity/");
     foreach ($activitiess as $activitie) { 
    ?>
 <div class="section-sliderimg">
        <img src="<?php echo $path.$activitie['featured_img']; ?>" alt="">
        <div class="overlay">
            <div class="caption">
                <h1><?php echo $activitie['activity_name']; ?></h1>
                <p><?php
                   $string = $activitie['description'];;
        ...
        <div class="container">
            <div class="row car-detail">
                ...
                <div class="car-blog col-md-12">
                        <div class="row">
                            <div class="col-md-8 ">
                                <h1><?php echo $activitie['activity_name']; ?><span></span></h1>
                                ...
                                <h2>Interested in this activitie ?</h2>
                                ...
                                <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title=""
                                   ...
                                   data-target="#image-gallery">
                                    <img class="img-thumbnail"
                                         src="<?php echo $path.$activitie['featured_img']; ?>"
