            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 ">
                        <div class="block-one">
                                <h1>know more</h1>
                            <a href="#"><button  class="btn btn-danger btn-mobile"> mobile app</button></a>
                            <a href="#"><button  class="btn btn-danger btn-app">view details</button></a>
                    ...
                    <div class="col-md-4">
                            ...
                            <ul>
                                ...
                                <li><a href="#">expolore india </a></li>
                                <li><a href="#">honestrip s  coupons</a> </li>
                                <li> <a  href="#">honestrip s essentials</a></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <!-- <input type="number" class="form-control" id="exampleInputPassword1" placeholder="message"> -->
...
<script src="assests/js/trip.js"></script>
<script>
        function myFunction(x) {
            if (x.matches) { // If media query matches
                let slider_class= document.querySelector('.slider');
                slider_class.classList.add('regular-mobile');
                slider_class.classList.remove('regular');
            } else {
                let slider_class= document.querySelector('.slider');
                slider_class.classList.add('regular');
                slider_class.classList.remove('regular-mobile');
            }
            }
