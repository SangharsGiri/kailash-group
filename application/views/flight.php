  <?php
    $path  = base_url("uploads/flight/");
     foreach ($flightss as $flight) { 
    ?>
 <div class="section-sliderimg">
        <img src="<?php echo $path.$flight['featured_img']; ?>" alt="">
        <div class="overlay">
            <div class="caption">
                <h1><?php echo $flight['flight_title']; ?></h1>
                <p><?php
                   $string = $flight['flight_body'];;
        ...
        <div class="container">
            <div class="row car-detail">
                ...
                <div class="car-blog col-md-12">
                        <div class="row">
                            <div class="col-md-8 ">
                                <h1><?php echo $flight['flight_title']; ?><span></span></h1>
                                ...
                                <h2>Interested in this flight ?</h2>
                                ...
                                <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title=""
                                   ...
                                   data-target="#image-gallery">
                                    <img class="img-thumbnail"
                                         src="<?php echo $path.$flight['featured_img']; ?>"
